...
func runE(flags *v12.OvmOptions, cmd *cobra.Command, args []string) error {
...
func test(flags *v12.OvmOptions, cmd *cobra.Command, args []string) error {
