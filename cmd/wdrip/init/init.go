...
func NewCommand() *cobra.Command {
	...
	cmd.Flags().StringVar(&flags.Bucket, "bucket", "host-wdrip", "download package from bucket")
	cmd.Flags().StringVar(&flags.Config, "config", "", "cluster config file, use cordinate bootstrap if not provided")
	return cmd
}

func runE(flags *v12.WdripOptions, cmd *cobra.Command, args []string) error {
...
func test(flags *v12.WdripOptions, cmd *cobra.Command, args []string) error {
