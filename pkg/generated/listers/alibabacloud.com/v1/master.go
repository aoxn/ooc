...
type MasterLister interface {
	...
	List(selector labels.Selector) (ret []*v1.Master, err error)
...
// List lists all Masters in the indexer.
func (s *masterLister) List(selector labels.Selector) (ret []*v1.Master, err error) {
	err = cache.ListAll(s.indexer, selector, func(m interface{}) {
		ret = append(ret, m.(*v1.Master))
	})
	return ret, err
}
...
// List lists all Masters in the indexer for a given namespace.
func (s masterNamespaceLister) List(selector labels.Selector) (ret []*v1.Master, err error) {
...
// Get retrieves the Master from the indexer for a given namespace and name.
func (s masterNamespaceLister) Get(name string) (*v1.Master, error) {
	obj, exists, err := s.indexer.GetByKey(s.namespace + "/" + name)
	if err != nil {
		return nil, err
	}
	if !exists {
		return nil, errors.NewNotFound(v1.Resource("master"), name)
	}
	return obj.(*v1.Master), nil
}
